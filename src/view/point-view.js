...
import { DateFormat, POINT_ICON_SIZE } from '../const.js';
      ...
      <li class="trip-events__item">
        <div class="event">
          ...
          <div class="event__type">
            <img class="event__type-icon" width="${POINT_ICON_SIZE.LARGE}" height="${POINT_ICON_SIZE.LARGE}" src="img/icons/${this.#point.type}.png" alt="Event type icon">
          </div>
          ...
          <button class="event__favorite-btn ${this.#point.isFavorite ? 'event__favorite-btn--active' : ''}" type="button">
            ...
            <svg class="event__favorite-icon" width="${POINT_ICON_SIZE.MEDIUM}" height="${POINT_ICON_SIZE.MEDIUM}" viewBox="0 0 28 28">
